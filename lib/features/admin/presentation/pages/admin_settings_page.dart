...
import 'package:ticket_q/core/services/toast_service.dart';
...
class _AdminSettingsPageState extends State<AdminSettingsPage> {
        ...
        return Scaffold(
                  ...
                  child: TextButton(
                    onPressed: () {
                      ...
                      context
                          ...
                          .add(UpdateAppSettingsRequested(
                            AppSettings(
          ...
          body: ListView(
            ...
            children: [
              ...
              _buildSettingsGroup(isDark, [
                _buildActionTile(Icons.history_rounded, 'Log Audit Sistem',
                    'Lihat jejak aktivitas admin', Colors.grey, isDark),
                _buildActionTile(
                    Icons.cloud_download_outlined,
                    'Cadangkan Database',
                    'Simpan snapshot data sekarang',
                    Colors.teal,
                    isDark,
                    isLast: true),
              ]),
              ...
              Center(
                child: Opacity(
                  ...
                  child: Text(
                    ...
                    style: GoogleFonts.inter(
                        fontSize: 10, fontWeight: FontWeight.w600, height: 1.5),
                  ),
                ),
              ),
            ],
  ...
  Widget _buildDropdownTile(
    ...
    return ListTile(
      onTap: () {
        HapticHelper.medium();
        _showSelectionBottomSheet(title, options, value, onChanged, isDark);
      },
      contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 6),
      leading: _IconBox(icon: icon, color: color),
      title: Text(title,
  ...
  void _showSelectionBottomSheet(String title, List<String> options,
      String current, Function(String) onChanged, bool isDark) {
        ...
        child: Column(
          ...
          children: [
            ...
            ...options.map((opt) => ListTile(
                  ...
                  title: Text(opt,
                      style: GoogleFonts.inter(
                          fontWeight: isSelected(opt, current)
                              ? FontWeight.w800
                              : FontWeight.w500)),
                  trailing: isSelected(opt, current)
  ...
  Widget _buildActionTile(
      IconData icon, String title, String subtitle, Color color, bool isDark,
      {bool isLast = false}) {
    return Column(
      children: [
        ListTile(

...
import 'package:ticket_q/features/dashboard/presentation/pages/tabs/widgets/dashboard_widgets.dart';
              ...
              IconButton(
                ...
                onPressed: () {
                  ...
                  context.read<TicketListBloc>().add(
                      const list_event.FetchAllTicketsRequested(
                          page: 0, limit: 5));
                },
              ),
          ...
          body: RefreshIndicator(
            onRefresh: () async {
              context
                  ...
                  .add(const stats_event.FetchTicketStatsRequested());
              context.read<TicketListBloc>().add(
                  const list_event.FetchAllTicketsRequested(page: 0, limit: 5));
            },
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            _AdminSummaryItem(
                                label: 'SELESAI',
                                value:
                                    state.stats.resolved + state.stats.closed,
                        ...
                        children: [
                          ...
                          GridView.count(
                            ...
                            children: [
                              ...
                              StatCard(
                                  label: 'Kembali',
                                  value: state.stats.reopened.toString(),
                                  color: AppColors.danger,
                                  icon: Icons.refresh_rounded,
                                  isDark: isDark),
                              StatCard(
                                  label: 'Ditutup',
                                  value: state.stats.closed.toString(),
                          ...
                          Row(
                            children: [
                              _AdminShortcut(
                                  ...
                                  onTap: () =>
                                      context.push(AppRoutes.ticketManagement)),

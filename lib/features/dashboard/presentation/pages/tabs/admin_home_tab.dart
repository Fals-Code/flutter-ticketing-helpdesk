                  ...
                  _buildAnimatedSection(1, Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        _AdminSummaryItem(label: 'AKTIF', value: state.stats.open + state.stats.inProgress + state.stats.pending + state.stats.reopened, icon: Icons.hourglass_empty_rounded),
                        Container(width: 1, height: 32, color: Colors.white.withValues(alpha: 0.2)),
                        _AdminSummaryItem(label: 'SELESAI', value: state.stats.resolved + state.stats.closed, icon: Icons.verified_rounded),
                      ],
                    ),
                  )),
                  const SizedBox(height: 32),
                    ...
                    children: [
                      ...
                      GridView.count(
                        ...
                        children: [
                          ...
                          StatCard(label: 'Tertunda', value: state.stats.pending.toString(), color: AppColors.warning, icon: Icons.pause_circle_outline_rounded, isDark: isDark),
                          StatCard(label: 'Kembali', value: state.stats.reopened.toString(), color: AppColors.danger, icon: Icons.refresh_rounded, isDark: isDark),

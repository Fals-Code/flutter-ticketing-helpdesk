    ...
    return Scaffold(
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              context.read<TicketListBloc>().add(
                  const list_event.FetchTicketsRequested(page: 0, limit: 5));
            },
          ),
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          ...
          context
              .read<TicketListBloc>()
              .add(const list_event.FetchTicketsRequested(page: 0, limit: 5));
        },
                        ...
                        builder: (context, state) {
                          ...
                          return Column(
                            children: state.tickets
                                .take(5)
                                .map((ticket) => RecentTicketCard(
                                    ticket: ticket, isDark: isDark))
                                .toList(),
                          );
                        },
                      ),

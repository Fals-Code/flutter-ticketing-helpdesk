  ...
  Future<void> _pickAndUploadImage(BuildContext context) async {
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  _buildSourceOption(context, Icons.camera_alt_rounded,
    ...
    if (source != null) {
      ...
      if (pickedFile != null && context.mounted) {
        context
            .read<AuthBloc>()
            .add(UpdateAvatarRequested(File(pickedFile.path)));
      }
    }
  }
  ...
  void _showLogoutDialog(BuildContext context, bool isDark) {
    showGeneralDialog(
      ...
      pageBuilder: (context, anim1, anim2) => AlertDialog(
        ...
        content: Text('Apakah Anda yakin ingin mengakhiri sesi aktif Anda?',

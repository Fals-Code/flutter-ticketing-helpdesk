...
class _StaffDashboardPageState extends State<StaffDashboardPage>
                ...
                onPressed: () {
                  ...
                  context
                      ...
                      .add(stats_event.FetchTicketStatsRequested(
                        assignedToId:
                            user.role == UserRole.technician ? user.id : null,
                      ));
                  context
                      .read<TicketListBloc>()
                  ...
                  _buildAnimatedSection(
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          _buildStatusGrid(context, stats.open,
                              stats.inProgress, stats.resolved, stats.closed),
                        ],
                      )),
  ...
  Widget _buildSummarySection(
      bool isDark, int active, int resolved, int total) {
    return Container(
  ...
  Widget _buildStatusGrid(
      BuildContext context, int open, int prog, int res, int closed) {
    final isDark = Theme.of(context).brightness == Brightness.dark;

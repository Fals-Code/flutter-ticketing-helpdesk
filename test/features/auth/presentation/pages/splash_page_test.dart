...
void main() {
  ...
  group('SplashPage', () {
    ...
    testWidgets('renders in light theme without exception', (
      tester,
    ) async {
      await tester.pumpWidget(
        buildSubject(
    ...
    testWidgets(
      ...
      expect(state.debugControllerDuration, const Duration(milliseconds: 1500));
    ...
    testWidgets('hero collapse is visible by 900 ms', (tester) async {
      ...
      final initialHeroSize =
          tester.getSize(find.byKey(const ValueKey('splash-hero-container')));

      await tester.pump(const Duration(milliseconds: 900));

      final collapsedHeroSize =
          tester.getSize(find.byKey(const ValueKey('splash-hero-container')));
